...
#EMOTES BOT FIXED BY @PRINCE_WEBZ
#JOIN- @PRINCE_BOT_UPDATE
...
async def MaiiiinE():
    Uid , Pw = 'ENTER UID' , 'ENTER PASSWORD'
    ...
    os.system('clear')
    print(render('PRINCE_WEBZ', colors=['white', 'red'], align='center'))
    print('')
    print(f" - BoT STarTinG And OnLine on TarGet : {TarGeT}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")
    print("\n" + "="*50)
    print("Credit: @PRINCE_WEBZ")
    print("Join: @PRINCE_BOT_UPDATE")
    print("="*50 + "\n")
